...
async function fetchAccountData() {
	...
	if(chainId!=97){
        ...
        alert("Please connect with Binance Smart Chain - Testnet!");
		return false;
	}
	...
	$("#btn-connect").css("display", "none");
	$("#btn-disconnect").css("display", "block");
    let firstFive = accounts[0].substring(0, 5);
    let lastFive = accounts[0].substr(accounts[0].length - 5);
    ...
    $("#wallet_connect_text").html('WALLET CONNECTED!');
    //$("#wallet_connect").html(firstFive+"...."+lastFive);
...
async function onDisconnect() { 
    ...
    $("#wallet_connect_text").html('WALLET NOT CONNECTED!');
    $("#wallet_connect").html('WALLET ADDRESS COMES HERE');
}
