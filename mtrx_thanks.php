    ...
    <div id="confetti">
        <div class="congo_popup">
            <div class="popup_check">
                ...
                <p>You have successfully participated in our presale. Please check your token balance in the claim page. Metarix will announce a claim date soon! </p>
                <div class="popup_buttons">
                    <a href="mtrx_presale-on.php" class="popup_btns">Go Back To Sale</a>
                </div>
            </div>    
        </div> 
    </div>
