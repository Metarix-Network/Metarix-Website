                    ...
                    <tr>
                      ...
                      { 
                        ...
                        }else if($k > 9 )
                        {
                          ...
                          else if( $k == 82 && ($i < 44 || ($i > 47 && $i < 50 ) ||  ($i > 297 && $i < 303 ) ||  ($i > 318 && $i < 322 )|| ($i > 365 && $i < 370) || ($i > 532 && $i < 685 )))
                          {
                            $bgClass = "greenBG";
                          }
                          else if( $k == 83 && ($i < 44 || ($i > 47 && $i < 49 )  ||  ($i > 298 && $i < 304 )  ||  ($i > 318 && $i < 322 ) || ($i > 364 && $i < 369) || ($i > 533 && $i < 686 )))
                          {
                            $bgClass = "greenBG";
                          }
                          else if( $k == 84 && ($i < 44 || ($i > 47 && $i < 49 ) ||  ($i > 52 && $i < 54 ) || ($i > 299 && $i < 305 )  ||  ($i > 318 && $i < 321 ) || ($i > 362 && $i < 369) || ($i > 534 && $i < 687 )))
                          {
                            $bgClass = "greenBG";
                          }
                           else if( $k == 85 && ($i < 44 ||   ($i > 51 && $i < 53 ) ||  ($i > 65 && $i < 78 ) || ($i > 300 && $i < 306 )  ||  ($i > 318 && $i < 321 ) || ($i > 361 && $i < 368) || ($i > 535 && $i < 688 )))
                          {
                            $bgClass = "greenBG";
                          }
                          else if( $k == 86 && ($i < 44 ||   ($i > 51 && $i < 54 ) ||  ($i > 57 && $i < 78 ) || ($i > 301 && $i < 307 )  ||  ($i > 318 && $i < 321 ) || ($i > 360 && $i < 367) || ($i > 536 && $i < 688 )))
                          {
                            $bgClass = "greenBG";
                          }
                          else if( $k == 87 && ($i < 44 ||  ($i > 51 && $i < 54 ) ||  ($i > 58 && $i < 77 ) || ($i > 302 && $i < 308 )  ||  ($i > 318 && $i < 320 ) || ($i > 359 && $i < 366) || ($i > 537 && $i < 689 )))
                          {
                            $bgClass = "greenBG";
                          }

                          else if( $k == 88 && ($i < 29 ||  ($i > 32 && $i < 40 ) ||  ($i > 48 && $i < 50 ) || ($i > 33 && $i < 40 ) || ($i > 51 && $i < 55 ) ||  ($i > 58 && $i < 76 ) || ($i > 303 && $i < 309 )   || ($i > 358 && $i < 365) || ($i > 538 && $i < 690 )))
                          {
                            $bgClass = "greenBG";
                          }

                          else if( $k == 89 && ($i < 29 ||  ($i > 33 && $i < 39 ) || ($i > 52 && $i < 55 ) || ($i > 48 && $i < 50 ) ||  ($i > 59 && $i < 75 ) || ($i > 304 && $i < 310 )   || ($i > 357 && $i < 366) || ($i > 537 && $i < 689 )))
                          {
                            $bgClass = "greenBG";
                          }
