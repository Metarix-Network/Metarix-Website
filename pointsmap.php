                    ...
                    <tr>
                      ...
                      { 
                        ...
                        }else if($k > 9 )
                        {
                          ...
                          else if( $k == 82 && ($i < 44 || ($i > 47 && $i < 49 )  ||  ($i > 298 && $i < 304 )  ||  ($i > 318 && $i < 322 ) || ($i > 364 && $i < 369) || ($i > 531 && $i < 686 )))
                          {
                            $bgClass = "greenBG";
                          }
                          else if( $k == 83 && ($i < 44 || ($i > 47 && $i < 49 ) ||  ($i > 52 && $i < 54 ) || ($i > 299 && $i < 305 )  ||  ($i > 318 && $i < 321 ) || ($i > 363 && $i < 368) || ($i > 532 && $i < 687 )))
                          {
                            $bgClass = "greenBG";
                          }
                           else if( $k == 84 && ($i < 44 ||   ($i > 51 && $i < 53 ) ||  ($i > 65 && $i < 78 ) || ($i > 300 && $i < 306 )  ||  ($i > 318 && $i < 321 ) || ($i > 362 && $i < 367) || ($i > 532&& $i < 688 )))
                          {
                            $bgClass = "greenBG";
                          }
                          else if( $k == 85 && ($i < 44 ||   ($i > 51 && $i < 54 ) ||  ($i > 57 && $i < 78 ) || ($i > 301 && $i < 307 )  ||  ($i > 318 && $i < 321 ) || ($i > 360 && $i < 366) || ($i > 533&& $i < 688 )))
                          {
                            $bgClass = "greenBG";
                          }
                          else if( $k == 86 && ($i < 29 ||   ($i > 32 && $i < 41 ) || ($i > 51 && $i < 54 ) ||  ($i > 58 && $i < 77 ) || ($i > 302 && $i < 308 )  ||  ($i > 318 && $i < 320 ) || ($i > 359 && $i < 365) || ($i > 533&& $i < 689 )))
                          {
                            $bgClass = "greenBG";
                          }

                          else if( $k == 87 && ($i < 28 ||  ($i > 32 && $i < 40 ) ||  ($i > 48 && $i < 50 ) || ($i > 33 && $i < 40 ) || ($i > 51 && $i < 55 ) ||  ($i > 58 && $i < 76 ) || ($i > 303 && $i < 309 )   || ($i > 358 && $i < 364) || ($i > 534 && $i < 689 )))
                          {
                            $bgClass = "greenBG";
                          }

                          else if( $k == 88 && ($i < 27 ||  ($i > 33 && $i < 40 ) || ($i > 52 && $i < 55 ) || ($i > 48 && $i < 50 ) ||  ($i > 59 && $i < 75 ) || ($i > 304 && $i < 311 )   || ($i > 356 && $i < 363) || ($i > 534 && $i < 689 )))
                          {
                            $bgClass = "greenBG";
                          }
                           
                           else if( $k == 89 && ($i < 26 ||  ($i > 33 && $i < 39 ) || ($i > 53 && $i < 56 ) || ($i > 47 && $i < 50 ) ||  ($i > 59 && $i < 74 ) || ($i > 305 && $i < 312 )   || ($i > 355 && $i < 362) || ($i > 535 && $i < 689 )))
                          {
                            $bgClass = "greenBG";
                          }
                          
                           else if( $k == 90 && ($i < 12 ||   ($i > 15 && $i < 25 )  || ($i > 43 && $i < 51 ) || ($i > 47 && $i < 50 ) ||  ($i > 59 && $i < 73 ) || ($i > 306 && $i < 313 )   || ($i > 354 && $i < 361) || ($i > 535 && $i < 689 )))
                          {
                            $bgClass = "greenBG";
                          }


                           else if( $k == 91 && ($i < 11 ||   ($i > 16 && $i < 24 )  || ($i > 43 && $i < 52 ) || ($i > 47 && $i < 49 ) ||  ($i > 59 && $i < 72 ) || ($i > 308 && $i < 314 )   || ($i > 354 && $i < 361) || ($i > 535 && $i < 689 )))
                          {
                            $bgClass = "greenBG";
                          }
